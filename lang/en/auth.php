...
$string['login_failed_no_user'] = 'Login failed for the username \'{$a->username}\'. User does not exist (error ID \'{$a->reasonid}\').';
$string['login_failed_user_suspended'] = 'Login failed for user \'{$a->username}\'. User is suspended (error ID \'{$a->reasonid}\').';
$string['login_failed_wrong_password'] = 'Login failed for user \'{$a->username}\'. Most likely the password did not match (error ID \'{$a->reasonid}\').';
$string['login_failed_user_locked'] = 'Login failed for user \'{$a->username}\'. User is locked out (error ID \'{$a->reasonid}\').';
$string['login_failed_user_not_authorised'] = 'Login failed for user \'{$a->username}\'. User is not authorised (error ID \'{$a->reasonid}\').';
$string['login_failed_other'] = 'Login failed for user \'{$a->username}\', error ID \'{$a->reasonid}\'.';
